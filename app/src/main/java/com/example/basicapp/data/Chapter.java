...
public class Chapter {
    public static final String[] SubSectionsMathematik = {"1.1 Basis-Grundlagen Mathematik", "1.2 Mathematik in der Informatik",
            "1.3 Mathematik in der Biologie ", "1.4 Mathematik in der Chemie", "1.5 Mathematik in der Physik", "1.6 Mathematik in der Technik"};

    public static final String[] SubSectionsInformatik = {"2.1 Basis-Grundlagen Informatik", "2.2 Theoretische Informatik",
